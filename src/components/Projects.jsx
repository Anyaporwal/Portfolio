...
return ( <section
 ...
 >
<div className={`reveal ${isVisible ? "reveal-visible" : ""}`}> <div className="mb-8 flex items-center justify-between gap-4"> <div className="flex items-center gap-3"> <div className="h-8 w-1 rounded-full bg-gradient-to-b from-accent to-accent-soft" /> <div> <p className="text-lg font-bold uppercase tracking-[0.2em] text-accent-soft">
Projects </p> <h2 className="text-base font-semibold text-slate-900 dark:text-slate-50 sm:text-base">
What I've Built </h2> 
</div> 
</div> 
</div>
